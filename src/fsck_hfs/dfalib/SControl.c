 ...
 *
 * FIXME: Get this building properly within Xcode, without need for the version.pl script!
 */
const unsigned char fsck_hfsVersionString[] = "PROGRAM:fsck_hfs  PROJECT:hfs-556.60.1";
