 ...
 * To find more about your gcc/clang compiler, run "gcc -dM -E - < /dev/null".
 * If cross compiling, add the target, "-target '<arch><sub>-<vendor>-<sys>-<env>'".
 * Note: sub is optional (for arm, etc) and env denotes the binary abi env (elf/macho/android)
 */
...
#elif defined(__GNUC__) && defined(__FreeBSD_cc_version)
