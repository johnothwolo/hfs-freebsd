...
/* BIG ENDIAN Macros */
/*********************/
#define SWAP_BE16(__a) 							be16toh (__a)
#define SWAP_BE32(__a) 							be32toh (__a)
#define SWAP_BE64(__a) 							be64toh (__a)
...
int  hfs_swap_BTNode (BlockDescriptor *src, struct vnode* vp, enum HFSBTSwapDirection direction, 
