...
extern	void	BuildCatalogKey( HFSCatalogNodeID parentID, const CatalogName *name, boolean_t isHFSPlus,
								 CatalogKey *key);
...
extern void		CopyCatalogName( const CatalogName *srcName, CatalogName *dstName, boolean_t isHFSPLus);
