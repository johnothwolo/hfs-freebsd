...
enum {
	HFSDBG_WRITE        		= 0, // FSDBG_CODE(DBG_FSRW, 0),    /* 0x3010000 */
	HFSDBG_TRUNCATE     		= 0, // FSDBG_CODE(DBG_FSRW, 7),    /* 0x301001C */
	HFSDBG_READ         		= 0, // FSDBG_CODE(DBG_FSRW, 12),   /* 0x3010030 */
	HFSDBG_GETNEWVNODE  		= 0, // FSDBG_CODE(DBG_FSRW, 37),   /* 0x3010094 */
	HFSDBG_UPDATE       		= 0, // FSDBG_CODE(DBG_FSRW, 8192), /* 0x3018000 */
	HFSDBG_UNMAP_FREE    		= 0, // HFSDBG_CODE(0),	/* 0x03080000 */
	HFSDBG_UNMAP_ALLOC    		= 0, // HFSDBG_CODE(1),	/* 0x03080004 */
	HFSDBG_UNMAP_CALLBACK		= 0, // HFSDBG_CODE(2),	/* 0x03080008 */
	/* 0x0308000C is unused */
	HFSDBG_BLOCK_ALLOCATE		= 0, // HFSDBG_CODE(4),	/* 0x03080010 */
	HFSDBG_BLOCK_DEALLOCATE		= 0, // HFSDBG_CODE(5),	/* 0x03080014 */
	HFSDBG_READ_BITMAP_BLOCK	= 0, // HFSDBG_CODE(6),	/* 0x03080018 */
	HFSDBG_RELEASE_BITMAP_BLOCK	= 0, // HFSDBG_CODE(7),	/* 0x0308001C */
	HFSDBG_FIND_CONTIG_BITMAP	= 0, // HFSDBG_CODE(8),	/* 0x03080020 */
	HFSDBG_ALLOC_ANY_BITMAP		= 0, // HFSDBG_CODE(9),	/* 0x03080024 */
	HFSDBG_ALLOC_FIND_KNOWN		= 0, // HFSDBG_CODE(10),	/* 0x03080028 */
	HFSDBG_MARK_ALLOC_BITMAP	= 0, // HFSDBG_CODE(11),	/* 0x0308002C */
	HFSDBG_MARK_FREE_BITMAP		= 0, // HFSDBG_CODE(12),	/* 0x03080030 */
	HFSDBG_BLOCK_FIND_CONTIG	= 0, // HFSDBG_CODE(13),	/* 0x03080034 */
	HFSDBG_IS_ALLOCATED   		= 0, // HFSDBG_CODE(14),	/* 0x03080038 */
	/* 0x0308003C is unused */
	HFSDBG_RESET_EXTENT_CACHE	= 0, // HFSDBG_CODE(16),	/* 0x03080040 */
	HFSDBG_REMOVE_EXTENT_CACHE	= 0, // HFSDBG_CODE(17),	/* 0x03080044 */
	HFSDBG_ADD_EXTENT_CACHE		= 0, // HFSDBG_CODE(18),	/* 0x03080048 */
	HFSDBG_READ_BITMAP_RANGE	= 0, // HFSDBG_CODE(19),	/* 0x0308004C */
	HFSDBG_RELEASE_SCAN_BITMAP	= 0, // HFSDBG_CODE(20),	/* 0x03080050 */
	HFSDBG_SYNCER        		= 0, // HFSDBG_CODE(21),	/* 0x03080054 */
	HFSDBG_SYNCER_TIMED   		= 0, // HFSDBG_CODE(22),	/* 0x03080058 */
	HFSDBG_UNMAP_SCAN    		= 0, // HFSDBG_CODE(23),	/* 0x0308005C */	
	HFSDBG_UNMAP_SCAN_TRIM   	= 0, // HFSDBG_CODE(24),	/* 0x03080060 */
};
