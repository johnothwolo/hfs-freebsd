...
/********************************************************************************
	...
	boolean_t types and values
	
		boolean_t			A one byte value, holds "false" (0) or "true" (1)
		false			The boolean_t value of zero (0)
		true			The boolean_t value of one (1)
		
*********************************************************************************/
/*
	The identifiers "true" and "false" are becoming keywords in C++
	and work with the new built-in type "bool"
	"boolean_t" will remain an unsigned char for compatibility with source
