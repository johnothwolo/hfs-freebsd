...
static u_int32_t CheckExtents( void *extents, u_int32_t blocks, boolean_t isHFSPlus );
static OSErr  DeleteExtents( ExtendedVCB *vcb, u_int32_t fileNumber, int quitEarly, u_int8_t forkType, boolean_t isHFSPlus );
static OSErr  MoveExtents( ExtendedVCB *vcb, u_int32_t srcFileID, u_int32_t destFileID, int quitEarly, u_int8_t forkType, boolean_t isHFSPlus );
...
OSErr ExchangeFileIDs( ExtendedVCB *vcb, ConstUTF8Param srcName, ConstUTF8Param destName, HFSCatalogNodeID srcID, HFSCatalogNodeID destID, u_int32_t srcHint, u_int32_t destHint )
{
	...
	OSErr		err;
	boolean_t		isHFSPlus = ( vcb->vcbSigWord == kHFSPlusSigWord );
...
static OSErr  DeleteExtents( ExtendedVCB *vcb, u_int32_t fileID, int quitEarly,  u_int8_t forkType, boolean_t isHFSPlus )
{
	FCB *				fcb;
	ExtentKey *			extentKeyPtr;
	ExtentRecord		extentData;
...
static u_int32_t  CheckExtents( void *extents, u_int32_t totalBlocks, boolean_t isHFSPlus )
{
