...
int TreeIsDirty(BTreeControlBlockPtr btreePtr)
{
...
int UpdateHeader(BTreeControlBlockPtr btreePtr, boolean_t forceWrite)
{
	int				err;
									 ...
									 boolean_t				*foundRecord )
{
	...
	// assume foundRecord points to boolean_t
...
int	IsItAHint	(BTreeControlBlockPtr btreePtr, BTreeIterator *iterator, boolean_t *answer)
{
