...
static int hfs_ext_iter_next_group(struct hfs_ext_iter *iter);
static int hfs_ext_iter_update(struct hfs_ext_iter *iter,
								   HFSPlusExtentDescriptor *extents,
								   int count,
								   HFSPlusExtentRecord cat_extents);
static int hfs_ext_iter_check_group(hfs_ext_iter_t *iter);
 ...
 * inconsistent.
 */
int hfs_ext_iter_check_group(hfs_ext_iter_t *iter)
{
 ...
 * file.
 */
int hfs_ext_find(struct vnode* vp, off_t offset, hfs_ext_iter_t *iter)
{
	int ret;
 ...
 */
static int hfs_ext_iter_next_group(hfs_ext_iter_t *iter)
{
	int ret;
 ...
 * of 8 extents.
 */
int hfs_ext_iter_update(hfs_ext_iter_t *iter,
							HFSPlusExtentDescriptor *extents,
							int count,
							HFSPlusExtentRecord cat_extents)
{
 ...
 * too large.
 */
int hfs_ext_replace(hfsmount_t *hfsmp, struct vnode* vp,
						uint32_t file_block,
