...
int BTOpenPath(FCB *filePtr, KeyCompareProcPtr keyCompareProc)
{
	int				err;
...
int	BTSearchRecord		(FCB						*filePtr,
...
int	BTIterateRecord		(FCB						*filePtr,
...
int	BTInsertRecord		(FCB						*filePtr,
								 BTreeIterator				*iterator,
								 FSBufferDescriptor			*record,
								 u_int16_t					 recordLen )
{
...
int	BTReplaceRecord		(FCB						*filePtr,
								 BTreeIterator				*iterator,
								 FSBufferDescriptor			*record,
								 u_int16_t					 recordLen )
{
...
int	BTDeleteRecord		(FCB						*filePtr,
								 BTreeIterator				*iterator )
{
	int				err;
	BTreeControlBlockPtr	btreePtr;
...
int	BTGetInformation	(FCB					*filePtr,
...
int	BTInvalidateHint	(BTreeIterator				*iterator )
{
	if (iterator == nil)
		return	paramErr;
...
int	BTHasContiguousNodes	(FCB	 				*filePtr)
{
	BTreeControlBlockPtr	btreePtr;
