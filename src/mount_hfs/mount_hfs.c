...
//            break;
            fprintf(stderr, "HFS additional encodings aren't supported\n");
            exit(5);
		case 'o':
			{
				int dummy;
...
struct hfs_mnt_encoding* a_encoding(char *s)
{
	char *uname;
	int i;
	u_int32_t encoding;
